...
$STORE_MODE = "mailchimp";
 ...
 MailChimp API Key findable in your Mailchimps dashboard
 $API_KEY =  "aac91c2d0f449dc17cb85cf3ad3c3b6a-us20";
...
if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST["newsletter"])) {
    ...
    if(filter_var($newsletter, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($STORE_MODE == "file") {
            ...
            // SUCCESS SENDING
            if(@file_put_contents($STORE_FILE, strtolower($newsletter)."\r\n", FILE_APPEND)) {
