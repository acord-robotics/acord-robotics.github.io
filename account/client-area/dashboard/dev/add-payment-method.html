...
<head>
    ...
    <title>Martplace - Add Payment Method</title>
                                    ...
                                    <ul class="payment_method">
                                        ...
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt5">
                                                    <img src="images/dis.jpg" alt="payment cards">
                                                    <span class="circle"></span>
                                                </label>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="custom-radio custom_radio--big">
                                                ...
                                                <label for="opt6">
                                                    <img src="images/ami.jpg" alt="payment cards">
                                                    <span class="circle"></span>
                                                </label>
                                            </div>
                                        </li>
                                ...
                                <div class="payment_info modules__content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <button type="submit" class="btn btn--round btn--default">Add Credit Now</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- end /.payment_info -->
