...
(function(global, factory) {
    ...
    // slide
    var SLIDE_DEFAULT_SEL =     '.fp-solid-slide'; // Replaced .slide by .fp-solid-slide to avoid any issues with Bootstrap carousel
    var SLIDE =                 'fp-slide';
    var SLIDE_SEL =             '.' + SLIDE;
    ...
    $.fn.fullpage = function(options) {
        ...
        options = $.extend({
            ...
            afterLoad: function(anchorLink, index){
                ...
                if(index !== $('#fullpage #section0').length){
                    $('.navbar, .navbar-nav, #fp-nav').addClass('next_home');
                    $(".brand-logo img").attr("src","img/logo-dark.png");
                    document.getElementById('YTPlayer-pause').click();
                } else {
                    $('.navbar, .navbar-nav, #fp-nav').removeClass('next_home');
                    $(".brand-logo img").attr("src","img/logo.png");
                    document.getElementById('YTPlayer-play').click();
                }
            },
        ...
        */
        function getScrollSettings(v){
            ...
            if(options.autoScrolling && !options.scrollBar){
                ...
                scroll.options = { 'scrollTop': v.dtop - 70};
